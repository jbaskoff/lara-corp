...
<head>
    ...
    <link rel="stylesheet" id="google-fonts-css"
          href="{{ asset(env('THEME')) }}/http://fonts.googleapis.com/css?family=Oswald%7CDroid+Sans%7CPlayfair+Display%7COpen+Sans+Condensed%3A300%7CRokkitt%7CShadows+Into+Light%7CAbel%7CDamion%7CMontez&amp;ver=3.4.2"
          type="text/css" media="all"/>
...
<div class="bg-shadow">
    ...
    <div id="wrapper" class="group">
        ...
        <div id="header" class="group">
            ...
            <div class="group inner">
                ...
                <div id="logo" class="group">
                    <a href="{{ asset(env('THEME')) }}/index.html" title="Pink Rio"><img
            ...
            <ul class="slider">
                <li>
                    <div class="slide-holder"
                         style="background:  url('{{ asset(env('THEME')) }}/images/slider-cycle/xx.jpg') no-repeat center center"
                         style="height:483px;">
                ...
                <li>
                    <div class="slide-holder"
                         style="background:  url('{{ asset(env('THEME')) }}/images/slider-cycle/00314.jpg') no-repeat center center"
                         style="height:483px;">
                        <div class="slide-content-holder inner" style="height:483px;">
            ...
            <div id="yit-widget-area" class="group">
                <div class="yit-widget-content inner group">
                    ...
                    <div class="yit-widget widget col1_4 one-fourth col widget-last-post group">
                        ...
                        <div>
                            <h3><a class="text-color" href="{{ asset(env('THEME')) }}/#" title="">Blog news</a></h3>
                            <p>Section shortcodes &amp; sticky posts! <a href="{{ asset(env('THEME')) }}/article.html">
                                    | more →</a></p>
                        </div>
                    </div>
                        ...
                        <div class="recent-post group">
                            <div class="hentry-post group">
                                <div class="thumb-img"><img
                                            src="{{ asset(env('THEME')) }}/images/articles/001-55x55.png" alt="001"
                                            title="001"/></div>
                                <div class="text">
                                    <a href="{{ asset(env('THEME')) }}/article.html"
                                       title="Section shortcodes &amp; sticky posts!" class="title">Section shortcodes
                                        &amp; sticky posts!</a>
                            ...
                            <div class="hentry-post group">
                                <div class="thumb-img"><img
                                            src="{{ asset(env('THEME')) }}/images/articles/003-55x55.jpg" alt="003"
                                            title="003"/></div>
                                <div class="text">
                                    <a href="{{ asset(env('THEME')) }}/article.html"
                                       title="Nice &amp; Clean. The best for your blog!" class="title">Nice &amp; Clean.
                                        The best for your blog!</a>
                                    <p class="post-date">September 24, 2012</p>
                                </div>
                            </div>
                            <div class="hentry-post group">
                                <div class="thumb-img"><img
                                            ...
                                            title="0037"/></div>
                                <div class="text">
                                    <a href="{{ asset(env('THEME')) }}/article.html" title="Another theme by YIThemes!"
        ...
        <div id="copyright">
            <div class="inner group">
                <div class="left">
                    <a href="{{ asset(env('THEME')) }}/http://yithemes.com/?ddownload=2046&ap_id=pinkrio-html"><strong>Download
                            the free version for Wordpress</strong></a>
                </div>
                <div class="right">
                    <a href="{{ asset(env('THEME')) }}/#" class="socials-small facebook-small"
                       title="Facebook">facebook</a>
                    <a href="{{ asset(env('THEME')) }}/#" class="socials-small rss-small" title="Rss">rss</a>
                    <a href="{{ asset(env('THEME')) }}/#" class="socials-small twitter-small"
                       title="Twitter">twitter</a>
                    <a href="{{ asset(env('THEME')) }}/#" class="socials-small flickr-small" title="Flickr">flickr</a>
                    <a href="{{ asset(env('THEME')) }}/#" class="socials-small skype-small" title="Skype">skype</a>
                    <a href="{{ asset(env('THEME')) }}/#" class="socials-small google-small" title="Google">google</a>
                    <a href="{{ asset(env('THEME')) }}/#" class="socials-small pinterest-small" title="Pinterest">pinterest</a>
                </div>
            </div>
        </div>
        <!-- END COPYRIGHT -->
